...
SceneB3::SceneB3(SDL_Window* sdlWindow_, GameManager* game_) :
	...
	platform3(11, 10, 5, 1, Vec4(255, 255, 255, 255), "vent/vent_h1.png"),
...
void SceneB3::Update(const float deltaTime) {
	...
	triggerEvent.OnTriggerEnter(game, DefineScenes::B2, DefineScenes::B3);
	triggerEvent2.OnTriggerEnter(game, DefineScenes::B4, DefineScenes::B3);
...
void SceneB3::HandleEvents(const SDL_Event& event)
{
...
bool SceneB3::RectsAreEqual(const SDL_FRect& rect1, const SDL_FRect& rect2)
{
